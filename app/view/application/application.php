...
<html>
  ...
  <body>
    ...
    <!--  <div id="wrap-report" class="t2 clearfix" style="display:none!important;">
     ...
     <!-- Block content main-->
      ...
      <div id="wrap-main" class="clearfix">
        <div id="wrap-main-menu">
          <div id="main-menu-show-and-hide">
            <button id="show-and-hide" class="show-and-hide fa fa-bars"></button>
          </div>
          <div class="report-panel">
            <secton>
              <h3>Month</h3>
